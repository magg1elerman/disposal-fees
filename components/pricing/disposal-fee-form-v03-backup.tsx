                                    ...
                                    <TooltipProvider delayDuration={100}>
                                      ...
                                      {/* <TooltipProvider delayDuration={100}>
                                        <Tooltip>
                                          ...
                                          <TooltipContent side="right" className="max-w-[300px] p-3">
                                            <p className="font-medium mb-1">Auto-calculate Minimum Charge</p>
                                            <p className="text-sm text-muted-foreground">
                                              When enabled, minimum charge will be automatically calculated as included tonnage × rate for each material. 
                                              Disable to set minimum charges manually.
                                            </p>
                                          </TooltipContent>
                                        </Tooltip>
                                      </TooltipProvider> */}
