...
export function DisposalFeeFormV5c({ initialFee, onSave, onCancel }: DisposalFeeFormProps) {
  // Form state
  ...
  const handleMaterialToggle = (material: string) => {
    setSelectedMaterials((prev) => {
      if (prev.includes(material)) {
        ...
        // Initialize material pricing with default values and appropriate unit of measure
        ...
        setMaterialPricing((prev) => ({
          ...
          [material]: {
            ...
            minCharge: "",
            freeTonnage: 0,
            rateStructure: defaultUnitOfMeasure,
            overageThreshold: 0,
            overageCharge: "",
            chargeable: false,
          }
  ...
  return (
    <div className="">
      <div className="p-6">
        <h2 className="text-xl font-bold">Disposal Fee Template v05c</h2>
        <div>
            {/* <ul className="list-disc list-inside px-2 text-sm">
                <li> Updating the materials table to show the unit of measure and rate</li>
                <li> Updating the materials table to show the included amount</li>
                <li> Updating the materials table to show the minimum charge</li>
                <li> Updating the materials table to show the overage threshold</li>
                <li> Updating the materials table to show the overage fee</li>
            </ul> */}
        </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <Label htmlFor="show-advanced" className="text-sm text-muted-foreground">Advanced Settings</Label>
                        <Switch
                          id="show-advanced"
                          ...
                          <Table>
                            <TableHeader>
                              <TableRow>
                                ...
                                <TableHead className={cn("w-[220px]", !showAdvancedColumns && "hidden")}>
                                  <div className="flex items-center space-x-2">
                                    <span>Included Amount</span>
                                  </div>
                                </TableHead>
                                <TableHead className={cn("w-[220px]", !showAdvancedColumns && "hidden")}>
                                  <div className="flex items-center space-x-2">
                                ...
                                <TableHead className={cn("w-[220px]", !showAdvancedColumns && "hidden")}>Overage Threshold</TableHead>
                                <TableHead className={cn("w-[220px]", !showAdvancedColumns && "hidden")}>Overage Fee</TableHead>
                              </TableRow>
                            </TableHeader>
                            <TableBody>
                              {selectedMaterials.map((materialName, index) => {
                                ...
                                return (
                                  <TableRow key={material.id}>
                                    ...
                                    <TableCell className={cn("w-[220px]", !showAdvancedColumns && "hidden")}>
                                      <div className="relative flex items-center gap-2">
                                    ...
                                    <SelectContent>
                                      {materials
                                        .filter(material => {
                                          ...
                                          // Show all materials except liquid waste (except Fuel) for other rate structures
                                          return !["Oil-based Paint", "Household Chemicals", "General Liquid Waste"].includes(material.name) &&
                                            !selectedMaterials.includes(material.name)
                                        })
                                        .map((material) => (
                                          <SelectItem
